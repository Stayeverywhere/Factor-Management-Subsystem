...
class HSTORE(sqltypes.Indexable, sqltypes.Concatenable, sqltypes.TypeEngine):
    """Represent the KingbaseES HSTORE type.
    ...
    * Concatenation::
    ...
    .. seealso::
        ...
        :class:`.hstore` - render the KingbaseES ``hstore()`` function.
...
class hstore(sqlfunc.GenericFunction):
    ...
    KingbaseES ``hstore()`` function.

    The :class:`.hstore` function accepts one or two arguments as described
    in the KingbaseES documentation.

    E.g.::

        from sqlalchemy.dialects.kingbase import array, hstore
    ...
    .. seealso::
        ...
        :class:`.HSTORE` - the KingbaseES ``HSTORE`` datatype.
...
#
# parsing.  note that none of this is used with the ksycopg2 backend,
