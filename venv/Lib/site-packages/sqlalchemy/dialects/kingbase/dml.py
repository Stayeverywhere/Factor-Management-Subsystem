...
class Insert(StandardInsert):
    """KingbaseES-specific implementation of INSERT.

    Adds methods for PG-specific syntaxes such as ON CONFLICT.

    The :class:`_kingbase.Insert` object is created using the
    :func:`sqlalchemy.dialects.kingbase.insert` function.
    ...
    def excluded(self):
        ...
        .. seealso::
            ...
            :ref:`kingbase_insert_on_conflict` - example of how
    ...
    def on_conflict_do_update(
        ...
        .. seealso::
            ...
            :ref:`kingbase_insert_on_conflict`
...
insert = public_factory(
    Insert, ".dialects.kingbase.insert", ".dialects.kingbase.Insert"
)
    ...
    def __init__(self, constraint=None, index_elements=None, index_where=None):
        ...
        if constraint is not None:
            ...
            if isinstance(constraint, util.string_types):
                ...
                index_where = constraint.dialect_options["kingbase"].get(
                    "where"
                )
