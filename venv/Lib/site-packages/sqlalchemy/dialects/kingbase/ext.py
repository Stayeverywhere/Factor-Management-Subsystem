...
class aggregate_order_by(expression.ColumnElement):
    """Represent a KingbaseES aggregate order by expression.

    E.g.::

        from sqlalchemy.dialects.kingbase import aggregate_order_by
...
class ExcludeConstraint(ColumnCollectionConstraint):
    ...
    Defines an EXCLUDE constraint as described in the `kingbase
    documentation`__.
...
def array_agg(*arg, **kw):
    """KingbaseES-specific form of :class:`_functions.array_agg`, ensures
    return type is :class:`_kingbase.ARRAY` and not
